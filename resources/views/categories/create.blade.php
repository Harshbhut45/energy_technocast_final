                ...
                <div class="table-responsive">
                  <div class="container-fluid">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                              <label for="inputGroupFile01">Image: @if(!isset($category)) <span class="tx-danger">*</span>@endif</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input {{ $errors->has('image') ? ' is-invalid' : '' }}" id ="image"
                                            aria-describedby="inputGroupFileAddon01" name='image' value="{{isset($category) ? $category->image : old('image') }}" @if(!isset($category)) required @endif>
